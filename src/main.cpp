...
// Copyright (c) 2016-xxxx The Wait Till Tomorrow developers
...
uint256 hashGenesisBlock("0xadddc5c5313294b7d4f140569adf59f11861ae8d438674355227366c340530e2");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(537261531); // TomorrowCoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "TomorrowCoin Signed Message:\n";
...
{
    // TomorrowCoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
static const int64 nTargetTimespan = 360; // TomorrowCoin: 6 minutes
static const int64 nTargetSpacing = 60; // TomorrowCoin: 1 minute
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // TomorrowCoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // TomorrowCoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // TomorrowCoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xf68df2edb0c9d90c2cd739c8f72fb8f6e2ac23c26e081c18760f57143e8a493f");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "You will have to wait till Tomorrow for Tomorrow";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 3000000000;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("bd62f02b5ae80565908d033fb420486895879e04148a455e53724e5857542be58471c3a863be37cd90c3bbc8d26e2aa30753d6054c0a14edb9e4878005c70da69e") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1472869609;
        block.nBits    = 537261531;
        block.nNonce   = 108207233;

        if (fTestNet)
        {
            block.nTime    = 1472869609;
            block.nNonce   = 1684555679;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x0272417d539cd0a2f6c378b8271093a629c3e320567e8436955d7f6a4d152e6f"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // TomorrowCoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("TomorrowCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("TomorrowCoinMiner : ProcessBlock, block not accepted");
    }
